...
public class DepartmentDAOImpl implements DepartmentDAO
{
	...
	public Department readDepartment(int deptNumber) {
		...
		try {
			...
			//ur table is mydept
			ResultSet rs = st.executeQuery("select * from MYDEPT120 where deptno="+deptNumber);		
	...
	public void updateDepartment(Department deptObj) {
		...
		try {
			PreparedStatement pst = conn2.prepareStatement("UPDATE MYDEPT120 SET LOC=?, DNAME=? WHERE DEPTNO=?");
			System.out.println("Prepared The statement");
