...
//we are creating two interface because we want only source to withdraw
//and only destination to deposit so that the transaction occurs.
...
{
	static void transfer(Withdrawing source, Depositing target, float amountToTransfer)
	{
